	...
	return(
		<Background>
			<S.Container>
				...
				<S.TextContainer>
					<S.Text>
					Sou uma desenvolvedora front-end e estou no caminho para me tornar full-stack. Este portfólio é além de uma apresentação dos projetos que eu mais gosto, é também um diário da minha evolução nesse caminho.
					</S.Text>
					<br/>
					<S.Text>
